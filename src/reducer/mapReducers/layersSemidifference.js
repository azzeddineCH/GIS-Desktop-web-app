...
export default function layersSemidifference(state,TopologyName,Firstname,FirstId,Secondname,SecondId){
   ...
   console.log(features[0].getGeometry().getType(),features[1].getGeometry().getType(),bool);
        ...
        const intersectGeom = OverlayOp.symDifference(geom, otherGeom);
      ...
      if (newFeature.getGeometry().getCoordinates().length>0)
       ...
       {
        message.error('Semi difference result is empty'); 
       }
       return newMap 
